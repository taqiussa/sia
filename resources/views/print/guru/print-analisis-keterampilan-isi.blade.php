    ...
    <table class="w-full text-[8px] font-semibold">
        <thead>
            <tr>
                ...
                <th class="border border-collapse border-black" colspan="4">Aspek Penilaian</th>
            ...
            <tr>
                <th class="border border-collapse border-black">Aspek 1</th>
                <th class="border border-collapse border-black">Aspek 2</th>
                <th class="border border-collapse border-black">Aspek 3</th>
                <th class="border border-collapse border-black">Aspek 4</th>
