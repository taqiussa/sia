...
const InputNilaiBinnadzorPerKelas = ({ initTahun, listJenisAlquran }) => {
        ...
        Sweet
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    destroy(
                        route('input-nilai-binnadzor-per-kelas.hapus', {
                            id: id,
                        }),
                        {
                            onSuccess: () => {
    ...
    return (
        <>
            <Head title='Binnadzor Per Kelas' />
            <div className="font-bold text-lg text-center text-slate-600 uppercase border-b-2 border-emerald-500 mb-3 bg-emerald-200">input nilai al qur'an binnadzor per kelas</div>
...
InputNilaiBinnadzorPerKelas.layout = page => <AppLayout children={page} />
export default InputNilaiBinnadzorPerKelas