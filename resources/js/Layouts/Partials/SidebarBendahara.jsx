    ...
    return (
        <div className='py-1'>
            ...
            <div>
                ...
                <SidebarLink closeSide={closeSide} href={route('data-pembayaran-siswa-custom')} active={route().current('data-pembayaran-siswa-custom')} label='data pembayaran siswa custom' />
