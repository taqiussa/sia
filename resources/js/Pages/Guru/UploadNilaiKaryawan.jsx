...
const UploadNilaiKaryawan = ({ initTahun }) => {
    ...
    return (
        <>
            <Head title='Upload Nilai Karyawan' />
            <div className="font-bold text-lg text-center text-slate-600 uppercase border-b-2 border-emerald-500 mb-3 bg-emerald-200">upload nilai karyawan</div>
