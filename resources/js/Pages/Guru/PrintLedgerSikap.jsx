...
const PrintLedgerSikap = ({ initTahun, initSemester, listKelas }) => {
    ...
    return (
        <>
            <Head title='Print Ledger Sikap' />
            <div className="bg-emerald-200 border-b-2 border-emerald-500 font-bold text-center text-lg text-slate-600 uppercase mb-2">print ledger sikap</div>
            <div className='lg:grid lg:grid-cols-4 lg:gap-2 lg:space-y-0 grid grid-cols-2 gap-2 pb-2'>
                ...
                <div className="flex items-end space-x-3">
                    <PrintLink href={route('print-ledger-sikap.print', {
                        tahun: data.tahun,
...
PrintLedgerSikap.layout = page => <AppLayout children={page} />
export default PrintLedgerSikap