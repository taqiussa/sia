...
const PrintNilaiAlquranTataUsaha = ({ initTahun, listKelas }) => {
...
PrintNilaiAlquranTataUsaha.layout = page => <AppLayout children={page} />
export default PrintNilaiAlquranTataUsaha