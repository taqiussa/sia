...
const RekapPenggajianBackup = ({ initTahun, listPenggajian, total }) => {
...
RekapPenggajianBackup.layout = page => <AppLayout children={page} />
export default RekapPenggajianBackup