...
@section('content')
    ...
    <table class="w-full border border-collapse border-black">
        <thead>
            <tr class="border border-collapse border-black">
                <th>No.</th>
                <th class="border border-collapse border-black">Tanggal Awal</th>
                <th class="border border-collapse border-black">Tanggal Akhir</th>
                <th class="border border-collapse border-black">Keterangan</th>
        ...
        <tbody>
            <tr class="border border-collapse border-black">
                ...
                <td class="border border-collapse border-black pl-1">{{ tanggal($tanggalAwal) }}</td>
                <td class="border border-collapse border-black pl-1">{{ tanggal($tanggalAkhir) }}</td>
