...
const DataPembayaranSiswaCustom = ({ initTahun, listPembayaran, filters }) => {
                ...
                if (result.isConfirmed) {
                    destroy(
                        route('input-pembayaran-siswa.hapus', {
                            id: id,
                            route: 'data-pembayaran-siswa-custom'
                        }),
                        {
                            onSuccess: () => {
...
DataPembayaranSiswaCustom.layout = page => <AppLayout children={page} />
export default DataPembayaranSiswaCustom